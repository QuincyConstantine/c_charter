...
import '../service_list/eswmo_services.dart';
import 'package:url_launcher/url_launcher.dart';
class EswmoHome extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => EswmoServicesScreen()),
        );
      },
      child: Card(
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              FaIcon(
                FontAwesomeIcons.recycle, // Using Font Awesome dollar sign icon
                size: 50,
                color: Colors.white,
              ),
              SizedBox(width: 15),
...
void _handleMenuClick(BuildContext context, int item) {
  switch (item) {
    case 0:
      _launchURL('https://forms.gle/Whc3K5AGgUtFWT45A');
      break;
  }
}

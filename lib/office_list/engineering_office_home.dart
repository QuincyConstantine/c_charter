...
import '../service_list/engineering_office_services.dart';
import 'package:url_launcher/url_launcher.dart';
class EngineeringOfficeHome extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => EngineeringOfficeServicesScreen()),
        );
      },
      child: Card(
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              FaIcon(
                FontAwesomeIcons.helmetSafety, // Using Font Awesome dollar sign icon
                size: 50,
                color: Colors.white,
              ),
              SizedBox(width: 15),
...
void _handleMenuClick(BuildContext context, int item) {
  switch (item) {
    case 0:
      _launchURL('https://forms.gle/ovJBm4RciQH5fuvv9');
      break;
  }
}

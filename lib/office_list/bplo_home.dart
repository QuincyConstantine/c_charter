...
import '../service_list/bplo_services.dart';
import 'package:url_launcher/url_launcher.dart';
class BploHome extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => BploServicesScreen()),
        );
      },
      child: Card(
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              FaIcon(
                FontAwesomeIcons.clipboard, // Using Font Awesome dollar sign icon
                size: 50,
                color: Colors.white,
              ),
              SizedBox(width: 15),
...
void _handleMenuClick(BuildContext context, int item) {
  switch (item) {
    case 0:
      _launchURL('https://forms.gle/yzWJ3XJqaiaL2WZZ7');
      break;
  }
}
